 ...
 * 
 * @source
 * [GitHub](https://github.com/mod-by-cis/hono-deno-ftp/blob/v0.2.6/mod/ftp/checks-folder-or-file.ts)
 * 
 * @jsr
 * [JSR](https://jsr.io/@cis/hono-ftp/0.2.6/mod/ftp/checks-folder-or-file.ts)
 */
